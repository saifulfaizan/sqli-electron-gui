// 📁 sqli.js (Scanner Power Mode - support custom payloads from UI)
...
async function handleSQLiTest(url, callback = () => {}, payloadList = null) {
  const startAll = Date.now();
  const log = [];
  const payloads = payloadList || defaultPayloads;
